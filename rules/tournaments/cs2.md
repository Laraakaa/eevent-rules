...
Please make sure that each Team is registered until 29.05.2026 17:30.

All group stage and Playoffs matches will be played one one site LAN Hosted Servers
...
|-----------|--------------------|------------|-----------------------------------------------------------------------------|
| Stage 1   | Swiss Rounds       | Bo1/Bo3    | All Qualifing games and Elimination Games are BO3. The top 6 teams qualify for the Playoffs, Top2 go straight to Semi-Finals. This Stage will be seeded according to the Seeding Procedure |                                                           
| Stage 2   | Single Elimination | Bo3/BO5    | The bracket will be seeded according to the result of the first stage       |

The amount of swiss rounds played during the first stage will adapt based on the total amount of teams participating.

## Schedule

The first appointment for the team representative will be the briefing on Friday at 18:00.
The tournament itself will start one hour later at 19:00.
...
### Map Pick-Ban
All matches are to use the following map pick-ban process for determining which map (bo1) or maps (bo3) are played.
...
1. Team B picks map 2
1. Team A chooses starting side on map 2
1. Team B picks the map 3
1. Team A chooses starting side on map 1
1. Team A picks map 4
1. Team B chooses starting side on map 4
1. Team A chooses starting side on map 5

<a id="seeding"></a>
### Seeding
<a id="Pre-event-Seeding"></a>
#### Pre-event Seeding
Coming into the event, all teams are sorted based on their current Average Faceit Elo or if a Team has no Faceit Accounts, Premier Rating will be used to give an Hipotetical Faceit Elo to Calculate the Average Teams Faceit Elo.

| Elo Conversion |  |  |
|:--------:|--------:|--------:|
| Below 10,000 Rating          | 1000 ELO                              |
| 10,000 - 12,000: Level 5 - 6 | 10,000 = 1051 ELO | 12,000 = 1276 ELO |
| 13,000 - 15,000: Level 6 - 7 | 13,000 = 1350 ELO | 15,000 = 1441 ELO |
| 15,000 - 18,000: Level 7 - 8 | 15,000 = 1531 ELO | 18,000 = 1641 ELO |
| 18,000 - 21,000: Level 9     | 18,000 = 1751 ELO | 21,000 = 2000 ELO |
| 22,000 - 25,000+: Level 10   | 22,000 = 2001 ELO | 25,000 = 2250 ELO |
...
* Stage 2: 
	* The advancing 6 teams will be seeds 1-6
...
*	Break during half time in overtimes: disable
